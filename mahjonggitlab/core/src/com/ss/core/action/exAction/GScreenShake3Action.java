...
public class GScreenShake3Action extends Action {
   int curOffX;
   int curOffY;
   float duration;
   Group[] layers;
   ...
   int shakeStregth = 25;
//   GLayer gr;
   public static GScreenShake3Action screenShake(float duration, int strength, GLayer... var1) {
      GScreenShake3Action var3 = (GScreenShake3Action)Actions.action(GScreenShake3Action.class);
